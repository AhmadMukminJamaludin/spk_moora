...
<!--===============================================================================================-->
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $base_url; ?>asset/Login/css/headmain.css">
<!--===============================================================================================-->
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<img src="<?php echo $base_url; ?>asset/Login/images/Logo_Kabupaten_Rembang.jpg" style="width:100px;height:100px;"/>
				<div>
				    <h4 align="center">SISTEM PENDUKUNG KEPUTUSAN PEMILIHAN PERANGKAT DESA MENGGUNAKAN METODE <i>MULTI-OBJECTIVE OPTIMIZATION ON THE BASES OF RATIO ANALISIS</i> (MOORA) PADA KANTOR BALAI DESA KARANGHARJO</h4>
				    <br>
				</div>

...
<div class="row-fluid">
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                if (isset($_POST['simpan']) && isset($_POST['thn'])) {
                    ...
                    $kriteria = $this->db->query("SELECT * from kriteria LEFT JOIN user on kriteria.user_id=user.id_user where tahun='$tahun'")->result();
                    $nomor = 0;
    ...
    <div class="span11">
      <div class="box">
          ...
          if (isset($_POST['simpan']) && isset($_POST['thn'])) {
            ...
            $c5 = $c->w5;//round($bobot_c4/($bobot_c1+$bobot_c2+$bobot_c3+$bobot_c4+$bobot_c5+$bobot_c6),4);
            $c6 = $c->w6;//round($bobot_c4/($bobot_c1+$bobot_c2+$bobot_c3+$bobot_c4+$bobot_c5+$bobot_c6),4);
          }
        }
          ?>
              </tbody>
  ...
  <div class="row">
    <div class="span11">
      <div class="box">
          <div class="box-header"> <span class="icon"><i class="icon-th"></i></span>
            <h5>Matriks Kinerja Ternormalisasi</h5>
          </div>
          <div class="box-body">
            ...
            $x6 = array();
            $i = 0;
            $query = $this->db->query("SELECT * from kriteria inner join user on kriteria.user_id=user.id_user where kriteria.tahun='$tahun'")->result();
    ...
    <div class="span11">
      <div class="box">
          <div class="box-header"> <span class="icon"><i class="icon-th"></i></span>
            <h5>Mengoptimalisasi Nilai Atribut</h5>
          </div>
          <div class="box-body">
            <table class="table table-bordered data-table">
              <thead>
    ...
    <div class="span11">
      <div class="box">
          <div class="box-header"> <span class="icon"><i class="icon-th"></i></span>
            <h5><i>Menghitung nilai y<small><i>i</i></small></h5>
          </div>
          <div class="box-body">
            <table class="table table-bordered data-table">
              <thead>
          ...
          <th width="40%">Alternatif</th>
            ...
            if (isset($_POST['simpan']) && isset($_POST['thn'])) {
                ...
                $tahun = $_POST['thn'];
                $query = $this->db->query("select * from kriteria inner join user on kriteria.user_id=user.id_user where kriteria.tahun='$tahun'")->result();
                $cek = $this->db->query("select * from rangking where tahun='$tahun'")->result();
                
                if(count($cek) > 0){
                  $clearall = $this->db->query("delete from rangking where tahun='$tahun'");
                }
                ...
                foreach ($query as $key) {
                  ?>
                   <tr>
                    <td><?php echo $a + 1; ?></td>
                    <td><?php echo $key->nama_user; ?></td>
                    <td><?php echo $y1[$a]+$y2[$a]+$y4[$a]+$y5[$a]+$y6[$a]; ?></td>
                    <td><?php echo $y3[$a]; ?></td>
                    <td><?php echo $y1[$a]+$y2[$a]+$y4[$a]+$y5[$a]+$y6[$a] - $y3[$a]; ?></td>
                  </tr>
                  <?php
    ...
    <div class="span11">
      <div class="box">
          ...
          <th width="40%">Alternatif</th>
            ...
            if (isset($_POST['simpan']) && isset($_POST['thn'])) {
                $tahun = $_POST['thn'];
            $get_kandidat = $this->db->query("SELECT * from rangking LEFT JOIN user on rangking.user_id=user.id_user order by nilai DESC")->result();
            $a = 0;
    ...
    <hr>
        ...
        <div class="box">
          <div class="box-body">
            <?php 
            $tahun = $_POST['thn'];
            $get_kandidat = $this->db->query("SELECT * from rangking JOIN user on rangking.user_id=user.id_user JOIN calon_perangkat_desa on calon_perangkat_desa.user_id=user.id_user where rangking.tahun='$tahun' order by nilai DESC limit 1")->result();
        ...
        <div class="widget-box">
          <div class="widget-content nopadding">
            <form method="GET" action="Laporan/cetak">
              <input type="hidden" name="thn" value="<?php echo $_POST['thn']; ?>">
            <button type="submit" id="cetak" name="cetak" class="btn btn-success">Cetak</button>
        </div>
        </div>
        <?php
        }
